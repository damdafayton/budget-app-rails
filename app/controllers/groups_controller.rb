class GroupsController < ApplicationController
  ...
  def show
    @expenditures = Expenditure.joins(%(INNER JOIN group_expenditures ON
            group_expenditures.expenditure_id = expenditures.id AND
            group_expenditures.group_id = #{params[:id]}))
  end
